...
def mind(
    ...
    other_user_embedding_layer = concatenate([user_id_embedding_layer, user_click_item_seq_embedding_layer_pooling], 
                                       axis=-1)
    ...
    user_inputs_list = [user_id_input_layer, user_click_item_seq_input_layer, user_click_item_seq_length_input_layer]
